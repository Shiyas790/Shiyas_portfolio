    ...
    <div
      ...
      <div>
        <Link to={"home"} smooth duration={600}>
          <h1 className="px-4 cursor-pointer font-medium capitalize text-gray-300 hover:scale-105 duration-200">
            <b>SHIYAS B</b>
          </h1>
        </Link>
      </div>
      ...
      <ul className="hidden md:flex">
        {links.map(({ id, link }) => (
          <li
            key={id}
            className="px-4 cursor-pointer font-medium capitalize text-gray-300  hover:text-indigo-400 hover:scale-105 duration-200"
          >
